# Matriz de Consistencia Base

## Linea de investigacion

Inteligencia Artificial y Comunicacion Inalambrica.
...
- robustez frente a ruido y heterogeneidad;
- capacidad de generalizacion.

Indicadores sugeridos:

- accuracy de clasificacion por zona o sala;
- error medio de localizacion;
- F1-score;
- estabilidad entre dispositivos o escenarios.
...
- precision de localizacion;
- oportunidad de activacion;
...
- tiempo de respuesta de la guia;
- tasa de error por sala o zona;
- porcentaje de sesiones con guia contextual correcta.

## Diseno metodologico preliminar

- Tipo de investigacion: aplicada.
- Nivel: explicativo y experimental.
- Metodo: cuantitativo.
- Diseno: cuasi experimental con comparacion entre baseline y modelo propuesto.
- Poblacion: registros de senales Wi-Fi/BLE y sesiones de guia virtual en espacios indoor.
- Muestra: subconjunto de huellas o dataset de entrenamiento, validacion y prueba.
- Tecnicas de recoleccion: captura de fingerprints, registro de RSSI y evaluacion del servicio.
- Tecnicas de analisis: metricas de clasificacion/localizacion y comparacion estadistica descriptiva.
