...
La reproduccion se organizo dentro de \texttt{laboratorios/Lab-02/Part-02}, separando claramente codigo fuente, datos, resultados y evidencias. El entregable incluye codigo reproducible, documentacion tecnica, metricas de ejecucion y un analisis comparativo con el paper.
...
El archivo \texttt{evidencias/comandos-ejecutados.txt} conserva la traza de ejecucion. A continuacion se muestra un extracto real incluido en la entrega:

\begin{quote}
\ttfamily\footnotesize
powershell -ExecutionPolicy Bypass -File laboratorios\textbackslash Lab-02\textbackslash Part-02\textbackslash scripts\textbackslash bootstrap\_env.ps1\\
python laboratorios\textbackslash Lab-02\textbackslash Part-02\textbackslash src\textbackslash prepare\_datasets.py --fingerprint-name lab02\_ble\_ferrero\\
python laboratorios\textbackslash Lab-02\textbackslash Part-02\textbackslash src\textbackslash train\_m2.py --fingerprint-name lab02\_ble\_ferrero --variant with\_empty\_values\\
python laboratorios\textbackslash Lab-02\textbackslash Part-02\textbackslash src\textbackslash evaluate\_m2.py --fingerprint-name lab02\_ble\_ferrero --variant without\_empty\_values
\end{quote}
...
El archivo \texttt{evidencias/metricas-reproduccion.csv} resume las metricas finales. Su contenido principal es:
...
Tambien se generaron archivos JSON en \texttt{resultados/metrics}. El siguiente bloque reproduce el contenido esencial de \texttt{m2\_without\_empty\_values\_evaluation.json}, que corresponde al escenario mas cercano a los resultados del paper:
...
\begin{itemize}
\item \texttt{resultados/models/M2/with\_empty\_values/model.keras}
\item \texttt{resultados/models/M2/without\_empty\_values/model.keras}
\item \texttt{resultados/models/M2/without\_empty\_values/training\_summary.json}
\item \texttt{resultados/metrics/m2\_with\_empty\_values\_evaluation.json}
\item \texttt{resultados/metrics/m2\_without\_empty\_values\_evaluation.json}
\item \texttt{evidencias/metricas-reproduccion.csv}
\item \texttt{evidencias/comandos-ejecutados.txt}
\end{itemize}
